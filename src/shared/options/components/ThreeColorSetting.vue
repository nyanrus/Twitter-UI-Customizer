<template>
    <template v-if="isBtnColors">
        <ColorSetting
            :id="id"
            type="background"
            :color_="TUICLibrary.color.getColorFromPref(id, 'background', editingColorType)"
            text="settingUI-colorPicker-background"
            :isDefault="settings[editingColorType]?.[id].background === true"
            :color-kind="editingColorType"
        />
        <ColorSetting
            :id="id"
            type="border"
            :color_="TUICLibrary.color.getColorFromPref(id, 'border', editingColorType)"
            text="settingUI-colorPicker-border"
            :isDefault="settings[editingColorType]?.[id].border === true"
            :color-kind="editingColorType"
        />
        <ColorSetting
            :id="id"
