    ...
    functions: {
        ...
        twitterIcon: function (elem, base) {
            switch (TUICPref.get("twitterIcon")) {
                ...
                case "twitter":
                    if (TUICPref.get("otherBoolSetting.faviconSet")) {
                        document.querySelector(`[rel="shortcut icon"]`).href = TWITTER.replace(
                ...
                case "twitterIcon-X":
                    if (TUICPref.get("otherBoolSetting.faviconSet")) {
                        document.querySelector(`[rel="shortcut icon"]`).href = X.replace(
                            `xmlns:xlink="http:%2F%2Fwww.w3.org%2F1999%2Fxlink"`,
                            `xmlns:xlink="http:%2F%2Fwww.w3.org%2F1999%2Fxlink"%20fill="${TUICLibrary.color.getColorFromPref(
                                "twitterIconFavicon",
                                "color",
        ...
        sidebarButtonProcess: function (bannerRoot) {
            ...
            for (const i of TUICData.settings.sidebarButtons.all) {
                if (
                    !TUICPref.get("sidebarButtons").includes(i) &&
            ...
            if (articles.length != 0) {
                articles.forEach(function (elem) {
                    ...
                    if (
                        ...
                        if (
                            TUICPref.get("timeline.hideOhterRTTL") &&
                        ...
                        for (var i = 0; i < TUICData.settings.visibleButtons.all.length; i++) {
                            if (
                                !TUICPref.get("visibleButtons").includes(
        ...
        osusumeUser: function () {
            if (
                TUICPref.get("timeline.osusume-user-timeline") &&
                ...
                for (const elem of cells) {
                    if (
                        ...
                        if (TUICPref.get("timeline-discoverMore") === "discoverMore_invisible") {
                            ...
                            TUICPref.get("timeline-discoverMore") === "discoverMore_detailOpen"
                        ) {
                            ...
                            TUICPref.get("timeline-discoverMore") === "discoverMore_detailClose"
                        ) {
            ...
            if (
                TUICPref.get("timeline.accountStart") &&
                location.search.indexOf("f=user") == -1 &&
                !location.href.includes("/settings/") &&
            ...
            if (
                TUICPref.get("rightSidebar.verified") &&
                document.querySelector(
            ...
            if (
                TUICPref.get("rightSidebar.trend") &&
                document.querySelector(
            ...
            if (
                TUICPref.get("rightSidebar.links") &&
                document.querySelector(
                    `[data-testid="sidebarColumn"] *:not(.${TUICLibrary.getClasses.getClass(
                        "TUIC_DISPNONE",
                    )}) > nav`,
            ...
            if (
                TUICPref.get("rightSidebar.searchBox") &&
                document.querySelector(
                    `[data-testid="sidebarColumn"] *:not(.${TUICLibrary.getClasses.getClass(
                        "TUIC_DISPNONE",
                    )}) [role="search"]`,
            ...
            if (
                TUICPref.get("rightSidebar.space") &&
                document.querySelector(
                    `[data-testid="sidebarColumn"] *:not(.${TUICLibrary.getClasses.getClass(
                        "TUIC_DISPNONE",
            ...
            if (
                TUICPref.get("invisibleItems.subscribe-tweets") &&
                window.location.pathname.includes("/status/") &&
                !isNaN(new URL(location.href).pathname.split("/")[3]) &&
                document.querySelector(
                    `*:not(.${TUICLibrary.getClasses.getClass(
